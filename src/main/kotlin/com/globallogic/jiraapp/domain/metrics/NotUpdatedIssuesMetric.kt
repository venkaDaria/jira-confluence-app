...
@Document(collection = "not_updated_issues_metrics")
class NotUpdatedIssuesMetric(
...
) : AbstractIssuesMetric<JqlMetric>(calculationTime, JqlMetric.NOT_UPDATED_ISSUES, result, status, currentIssues, otherIssues, id)
